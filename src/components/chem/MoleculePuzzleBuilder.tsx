...
export function MoleculePuzzleBuilder({ task, onChecked }: { task: StructureBuildTask; onChecked?: (correct: boolean, graph: MoleculeGraph) => void }) {
  ...
  return <section className="puzzle-builder">
    ...
    <p className="puzzle-free-build">Je mag een groep zoals <b>COOH</b> als blokje plaatsen, maar je mag hem ook zelf bouwen met <b>C, O, O en H</b>. Het systeem kijkt naar de bindingen, niet naar welk blokje je hebt gebruikt.</p>
