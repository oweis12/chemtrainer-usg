...
const sourceBinasReferences: BinasReferenceSource[] = [
  { id: "m4-40", subject: "Periodiek systeem en atoommassa's", module: "M4", table: "Tabel 40A", whenToUse: "Gebruik deze wanneer je een elementsymbool, formule-onderdeel of relatieve atoommassa nodig hebt voor een molmassa-berekening.", exampleQuestion: "Bereken de molmassa van CaCO₃ voordat je massa en mol aan elkaar koppelt.", warning: "Neem niet zomaar een afgeronde massa uit je hoofd: gebruik de waarde die bij jouw BINAS-editie staat en rond pas aan het einde af.", keywords: ["element", "formule", "molmassa", "atoommassa", "reactie"] },
  ...
  { id: "m5d-codontabel", subject: "Codontabel / genetische code", module: "M5D", table: "BINAS codontabel / genetische-code-tabel (vaak 117E/G; soms 71E/71G/71J)", whenToUse: "Gebruik deze wanneer je mRNA-codons naar aminozuren vertaalt of vanuit DNA eerst mRNA moet maken en daarna de aminozuurvolgorde bepaalt. In deze koers kan dat als BINAS 117E/G aangeduid zijn; sommige edities of schoolbronnen gebruiken 71E, 71G of 71J als alias.", exampleQuestion: "Zet 5′-AUG GCU UAA-3′ om naar aminozuren en leg uit waar het stopcodon de translatie laat eindigen.", warning: "Zoek in BINAS mRNA-codons op, niet rechtstreeks DNA-triplets. Controleer dus eerst of je een matrijsstreng, coderende streng of al een mRNA-fragment hebt, en onthoud dat RNA U gebruikt in plaats van T.", keywords: ["codon", "codontabel", "genetische code", "mrna", "translatie", "aminozuur", "transcriptie", "117e", "117g", "71e", "71g", "71j"] },
  { id: "m5d-eiwit-67", subject: "Aminozuren en eiwitstructuur", module: "M5D", table: "BINAS 67", whenToUse: "Gebruik BINAS 67 wanneer je aminozuurgroepen, peptide- en amidekoppelingen of de relatie tussen eiwitstructuur en eigenschappen moet onderbouwen.", exampleQuestion: "Leg uit welke functionele groepen in een aminozuur of peptidefragment terugkomen en hoe dat samenhangt met de structuur van een eiwit.", warning: "BINAS helpt je bij de bouwstenen en materiaal-/structuurcontext, maar je moet zelf nog steeds primaire, secundaire en tertiaire structuur onderscheiden en uitleggen wat denaturatie met de ruimtelijke vorm doet.", keywords: ["aminozuur", "aminozuren", "eiwit", "eiwitstructuur", "peptide", "amide", "denaturatie", "67"] },
...
export const binasFindingChallenges: BinasFindingChallenge[] = [
  ...
  { id: "bf-m5d-codon", module: "M5D", prompt: "Je moet van een mRNA-codon de aminozuurvolgorde bepalen na transcriptie. Welke BINAS-ingang zoek je eerst op?", referenceId: "m5d-codontabel", optionIds: ["m5d-codontabel", "m5d-eiwit-67", "m4-40", "m10-indicator"] },
