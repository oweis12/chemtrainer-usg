...
const sourceBinasReferences: BinasReferenceSource[] = [
  { id: "m4-40", subject: "Elementen, formules en atoommassa's", module: "M4", table: "Tabel 40", whenToUse: "Gebruik deze wanneer je een elementsymbool, formule-onderdeel of relatieve atoommassa nodig hebt voor een berekening.", exampleQuestion: "Bereken de molaire massa van CaCO₃ voordat je massa en mol aan elkaar koppelt.", warning: "Neem niet zomaar een afgeronde massa uit je hoofd: gebruik de waarde die bij jouw BINAS-editie staat en rond pas aan het einde af.", keywords: ["element", "formule", "molmassa", "molaire massa", "atoommassa", "reactie"] },
  ...
  { id: "m4-98", subject: "Molaire massa's van veelgebruikte stoffen", module: "M4", table: "Tabel 98", whenToUse: "Gebruik deze als een opgave vraagt om een molaire massa van een veelgebruikte stof of oplossing.", exampleQuestion: "Zet 0,250 mol NaOH om naar massa in gram.", warning: "Kies óf een opgegeven molaire massa uit de opgave óf BINAS; tel niet beide opnieuw samen met verschillende afrondingen.", keywords: ["molmassa", "molaire massa"] },
...
export const binasFindingChallenges: BinasFindingChallenge[] = [
  { id: "bf-m4-mass", module: "M4", prompt: "Je moet de molaire massa van CaCO₃ bepalen voordat je mol naar gram omzet. Welke BINAS-tabel is de logischste eerste stap?", referenceId: "m4-40", optionIds: ["m4-40", "m4-66a", "m6-45a", "m10-97a"] },
